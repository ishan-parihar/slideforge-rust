...
description: Use when choosing, parameters-filling, or structuring any of the 36 slide types. Directs you to text layouts, data visualizations, story flows, or image layouts.
---

# SlideForge Slide Composition Router

This router assists you in selecting and structuring slide content. SlideForge supports 36 slide types categorized into four primary design models. Descend into the correct sub-skill based on your content requirements.
...
- **Includes slide types:** `hero`, `quote`, `split_features`, `definition`, `text_block`, `section_divider`, `timeline`.
...
1. Read the [Slide Types Manifest](file:///home/ishanp/.agents/skills/slideforge/references/slide-types-manifest.md) for a comprehensive list of all 36 slide types, their required parameters, and best-for use cases.
