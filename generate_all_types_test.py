...
EXAMPLES = [
    ...
    ("hero", "split", "bold", "light", {"headline": "Beautiful by default", "subheadline": "Editorial themes tuned for carousels", "badge": "SlideForge", "tagline": "Visual proof", "metric_value": "47", "metric_label": "slide types"}, "Openers & Hooks"),
    ...
    # ── Narrative & Story ──────────────────────────────────────────────
    ("problem_solution", "default", "editorial", "dark", {"title": "The slide problem", "problem": "Design systems break at scale — tokens drift, components diverge.", "solution": "Compile-time validation catches violations before they ship.", "proof_points": "94 tests. Real-time composition check. Runtime geometry."}, "Narrative & Story"),
    ...
    ("before_after_story", "default", "editorial", "dark", {"before": "Manual 4-hour deck", "after": "5-minute CLI run", "title": "The shift", "metric": "48x faster"}, "Narrative & Story"),
    ("case_study_result", "default", "editorial", "dark", {"client": "TechCorp", "challenge": "12-deck/month, 3-day lag", "solution": "Adopted SlideForge CLI", "results": [{"metric": "3x", "label": "Content velocity"}, {"metric": "0", "label": "Token violations"}]}, "Narrative & Story"),
    ...
    ("metric_grid", "default", "editorial", "dark", {"title": "Pipeline metrics", "metrics": [{"value": "<10ms", "label": "Compile time"}, {"value": "47", "label": "Slide types"}, {"value": "28", "label": "Presets"}, {"value": "100%", "label": "Validated"}]}, "Data & Metrics"),
