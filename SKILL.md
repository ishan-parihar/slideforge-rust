...
hero, feature, list, quote, cta, comparison, stat_row, timeline, callout, split_features, grid_cards, definition, text_block, chart, column_chart, metric_grid, funnel_chart, progress_rings, comparison_bars, table, qr_destination, and more. Run `slideforge list-slides` for the full catalog.
