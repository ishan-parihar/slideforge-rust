...
SLIDES = [
    ...
    {"slide_type": "text_block", "theme": "editorial", "bg_style": "dark", "archetype": "thought_leader",
     "params": {"title": "The Future of AI-Driven Presentation Systems", "body": "Static design templates are being replaced by dynamic layout engines that calculate character density, scale typography, and enforce mathematical spacing rules at runtime."}},
    {"slide_type": "text_columns", "theme": "editorial", "bg_style": "light", "archetype": "educator",
     "params": {"title": "Architectural Benefits", "columns": [{"heading": "Speed", "body": "100x faster than browser-based DOM renderers."}, {"heading": "Precision", "body": "Zero text overflow or descender clipping."}]}},
